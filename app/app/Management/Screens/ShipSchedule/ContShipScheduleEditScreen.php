 ...
 * コンテナ船スケジュール編集画面
 */
class ContShipScheduleEditScreen extends Screen
{
    ...
    {
        //入力項目に「DOC CUT」「AM(=DOC CUTのAMフラグ)」を追加
        //「DOCUMENT CUT」の略で、DOCUMENTはDRを指している。
        $item = new ContShipScheduleItem();
        $item->documentCutAt;
        $item->documentAmCut;
    }
