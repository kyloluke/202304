...
/**
 * RORO船スケジュールの変更履歴の一覧の取得API
 */
class RoroShipScheduleGetIndexUpdateHistoryApi extends Api
{
    /**
     * @see Api::docId()
     */
    ...
    {
        return 'ship-schedule/roro/{id}/update-history';
    }
