...
namespace App\Management\Apis\Lp3Core\YardGroup;
...
/**
 * ヤードグループのCSVダウンロードAPI
 */
class YardGroupDownloadCsvApi extends Api
{
    /**
     * @see Api::docId()
     */
    ...
    {
        return 'yard-group/bulk/csv/download';
    }
