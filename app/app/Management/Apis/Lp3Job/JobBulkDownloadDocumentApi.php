...
namespace App\Management\Apis\Lp3Job;
...
/**
 * 複数JOBの書類の一括ダウンロードAPI
 */
class JobBulkDownloadDocumentApi extends Api
{
    /**
     * @see Api::docId()
     */
    ...
    {
        return 'job/bulk/document/bulk/download';
    }
