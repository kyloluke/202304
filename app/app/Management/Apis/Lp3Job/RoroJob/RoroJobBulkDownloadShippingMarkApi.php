...
/**
 * 複数ROROJOBのSHIPPING MARKのダウンロードAPI
 */
class RoroJobBulkDownloadShippingMarkApi extends Api
{
    /**
     * @see Api::docId()
     */
    ...
    {
        return '複数ROROJOBのSHIPPING MARKのダウンロード';
    }
    ...
    {
        return 'job/roro/bulk/shipping-mark/download';
    }
