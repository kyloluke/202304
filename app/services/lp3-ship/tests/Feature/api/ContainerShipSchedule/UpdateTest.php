...
it('no data', function () {
    ...
    // api call
    $result = $this->json('put', 'api/lp3-ship/ship-schedule/cont/100000', $dataForUpdating);
...
it('updates a ship-schedule', function () {
    ...
    // api call
    $result = $this->json('put', 'api/lp3-ship/ship-schedule/cont/' . $shipSchedule->id, $reqData);
