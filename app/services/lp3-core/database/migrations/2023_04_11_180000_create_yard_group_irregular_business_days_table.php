...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('yard_group_irregular_business_days', function (Blueprint $table) {
            $table->id();
            $table->foreignId('yard_group_id')->constrained('yard_groups')->comment("ヤードグループId");
            $table->dateTime('date')->comment("臨時営業日");
    ...
    {
        Schema::dropIfExists('yard_group_irregular_business_days');
    }
};
