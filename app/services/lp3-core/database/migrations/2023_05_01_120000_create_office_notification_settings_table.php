...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('office_notification_settings', function (Blueprint $table) {
            $table->id();
            $table->foreignId('office_id')->comment("事業所Id")->constrained('offices');
            $table->string('mail')->comment("メールアドレス");
            $table->integer('notification_type')->comment("通知設定");
    ...
    {
        Schema::dropIfExists('office_notification_settings');
    }
};
