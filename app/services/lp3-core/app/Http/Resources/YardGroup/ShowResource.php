...
use Services\Lp3Core\App\Http\Resources\Office\IndexResource as OfficeIndexResource;
...
class ShowResource extends BaseResource
{
    public function toArray($request)
    {
        ...
        foreach ($this->officeBusinessTypes as $officeBusinessType) {
            $officeResource = (new OfficeIndexResource($officeBusinessType->office))->toArray($request);
        ...
        return [
            ...
            'representativeYard' => !empty($this->representativeYard) ? (new YardResourceForYardGroup($this->representativeYard))->toArray($request) : null,
            ...
            'defaultPol' => !empty($this->defaultPol->id) ? [
