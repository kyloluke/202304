...
class UpdateRequest extends Request
{
    ...
    {
        return [
            'name' => ['required', 'max:50', new UniqueCheckRule(Destination::class,'仕向地名称', $this->destination)],// 重複チェックは同じのタイプ限りです
    ...
    public function bodyParameters(): array
    {
        return [
            ...
            'nameEn' => ['description' => '仕向地英語名称', 'example' => 'xxxx location name'],
