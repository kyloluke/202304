...
class StoreRequest extends Request
{
    ...
    {
        return [
            'name' => ['required', 'max:50', new UniqueCheckRule(Destination::class, '仕向地名称')], // 重複チェックは同じのタイプ限りです
            ...
            'timezone' => ['nullable', 'string', Rule::in(array_column(Timezone::cases(), 'value'))],
        ];
    }
    ...
    {
        return [
            'name' => ['description' => '仕向地名称', 'example' => 'xxxx物流センター'],
            'nameEn' => ['description' => '仕向地英語名称', 'example' => 'xxxxlocation name'],
            'countryId' => ['description' => '国ID', 'example' => '国テーブルの ID'],
